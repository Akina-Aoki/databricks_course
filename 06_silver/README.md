# 05_supply_chain_demo

This folder defines all source code for the '05_supply_chain_demo' pipeline:
...
* Take a look at the sample under "sample_users_05_supply_chain_demo.py" to get familiar with the syntax.
